...
<div class="page-title">
    <div class="row justify-content-between align-items-center">
        <div class="mb-3 col-md-6 mb-md-0">
            <h5 class="mb-0 text-white h3 font-weight-400">Realizar pago</h5>
        </div>
    </div>
</div>
<x-danger-alert />
                        ...
                        <div class="p-2 shadow-lg card p-md-4">
                            <div class="card-body">
                                ...
                                @if ($title != 'Complete Payment')
                                    ...
                                    @endphp
                                    <div>
                                        <h6 class="">Debes realizar el pago de
                                            <strong>{{ number_format($amount) }}</strong> pesos
                                        </h6>
                                        <h4>
                                            ...
                                            @if ($payment_mode->defaultpay == 'yes')
                                                ...
                                                @if ($payment_mode->name == 'Bank Transfer')
                                                    ...
                                                    @if (!empty($payment_mode->account_name))
                                                        <div class="d-block">
                                                            <h5 class="">Nombre de la cuenta</h5>
                                                        </div>
                                                        <div class="mb-3 input-group">
                                                            <input type="text" class="form-control readonly "
