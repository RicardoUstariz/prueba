    ...
    <div class="col-md-12">
        <div class="card ">
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo e(url('/crear-deposito')); ?>" class="form-container">
                    ...
                    <div id="deposit-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="1" max="<?php echo e($user->account_bal); ?>" id="value" name="value" value="$0" onkeyup="ponerPrecio()" required>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nb9pvggwxcwi/public_html/ultra.multipagos.co/core/resources/views/purpose/user/deposits.blade.php ENDPATH**/ ?>