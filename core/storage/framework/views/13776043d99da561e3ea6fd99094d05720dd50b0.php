...
<div class="page-title">
    <div class="row justify-content-between align-items-center">
        <div class="mb-3 col-md-6 mb-md-0">
            <h5 class="mb-0 text-white h3 font-weight-400">Bienvenido, <?php echo e(Auth::user()->name); ?>!</h5>
        </div>
    </div>
</div>
                ...
                <!--<header>
                    <div class="top-bar">
                        ...
                        <div class="user-info">
                            ...
                            <span class="user-id" style="color: #fff;">ID <?php echo e(Auth::user()->id); ?></span>
                        </div>
                    </div>
                    <nav>
                        <ul>
                ...
                <div class="row" style="padding: 5%;">
                    <div class="col-sm">
                        ...
                        <div class="product-container" id="productos">
                            <!--<div class="product">
                                <img src="<?php echo e(asset('assets/img/nequilogo')); ?>" alt="Be Ingresar">
                                <span>INGRESAR</span>
                            </div>-->
                        </div>
...
<script>
    ...
    let productos = [
        {
            img: '<?php echo e(asset('assets/img/bancolombialogo.png')); ?>',
            tipo: 'DEPÓSITO',
            name: 'Bancolombia',
        },
        {
        ...
        {
            img: '<?php echo e(asset('assets/img/logodaviplata.png')); ?>',
            tipo: 'DEPÓSITO',
            name: 'Daviplata',
        },
        {
        ...
        {
            img: '<?php echo e(asset('assets/img/nequilogo.png')); ?>',
            tipo: 'DEPÓSITO',
            name: 'Nequi',
        },
        {
        ...
        {
            img: '<?php echo e(asset('assets/img/logomiltipagos.png')); ?>',
            tipo: 'MULTIPAGOS',
            name: 'Multipagos',
        },
    ];
    ...
    async function verProducto(name, tipo) {
        ...
        if (tipo == 'DEPÓSITO') {
            ...
            window.location.href = '<?php echo e(route('withdrawalsdeposits')); ?>';
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nb9pvggwxcwi/public_html/ultra.multipagos.co/core/resources/views/purpose/user/dashboard.blade.php ENDPATH**/ ?>