<form method="post" action="javascript:void(0)" id="updatewithdrawalinfo">
    ...
    <?php if($bankTransfer->status == 'enabled'): ?>
        <fieldset>
            <div class="form-row">
    ...
    <fieldset class="mt-2">
        <div class="form-row">
            ...
            <?php endif; ?>
            <?php if($ethereum->status == 'enabled'): ?>
                <div class="form-group col-md-6">
            ...
            <?php endif; ?>
            <?php if($litecoin->status == 'enabled'): ?>
                <div class="form-group col-md-6">
...
<?php /**PATH /home/nb9pvggwxcwi/public_html/ultra.multipagos.co/core/resources/views/purpose/profile/update-withdrawal-method.blade.php ENDPATH**/ ?>