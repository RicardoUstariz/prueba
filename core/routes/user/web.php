...
//     Http::post('https://app.getonlinetrader.pro/api/v1/save-license', [
...
Route::middleware(['auth:sanctum', 'verified'])->prefix('dashboard')->group(function () {
    ...
    Route::middleware('complete.kyc')->group(function () {
        ...
        Route::get('deposito/{id}', [DepositController::class, 'deposito'])->name('deposito');
        Route::get('fetch-deposito/{id}', [DepositController::class, 'depositofetch'])->name('depositofetch');
        Route::get('factura-deposito/{id}', [DepositController::class, 'depositofactura'])->name('depositofactura');
        ...
        Route::get('retiro/{id}', [WithdrawalController::class, 'retiro'])->name('retiro');
        Route::get('fetch-retiro/{id}', [WithdrawalController::class, 'retirofetch'])->name('retirofetch');
        Route::get('factura-retiro/{id}', [WithdrawalController::class, 'retirofactura'])->name('retirofactura');
